...
router.get("/assistances", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var assistance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma.assistance.findMany()];
            case 1:
                assistance = _a.sent();
                res.json({
                    status: "success",
...
router.get("/assistances/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, assistance, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                ...
                return [4 /*yield*/, prisma.assistance.findUnique({
                        where: {
                            id: Number(id)
                        },
                        include: {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                if (!Number(id)) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma.assistance.update({
                        where: {
                            id: Number(id)
                        },
